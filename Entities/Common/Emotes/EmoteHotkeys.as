...
u8 emote_mine = Emotes::mine;
u8 emote_yours = Emotes::yours;
...
void onTick(CBlob@ this)
{
	...
	{
		if (XORRandom(10) == 0)
		this.getSprite().PlaySound("MineMine.ogg", 0.8+XORRandom(20)*0.01, this.getSexNum() == 0 ? 0.9+XORRandom(30)*0.1 : 1.4+XORRandom(30)*0.01 );
		set_emote(this, emote_mine, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_2))
	{
		set_emote(this, emote_2, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_3))
	{
		set_emote(this, emote_3, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_4))
	{
		set_emote(this, emote_4, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_5))
	{
		set_emote(this, emote_5, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_6))
	{
		set_emote(this, emote_6, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_7))
	{
		set_emote(this, emote_7, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_8))
	{
		set_emote(this, emote_8, 20);
	}
	else if (controls.isKeyJustPressed(KEY_KEY_9))
	{
		set_emote(this, emote_9, 20);
	}
