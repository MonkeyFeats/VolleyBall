...
int zoomLevel = 6; // we can declare a global because this script is just used by myPlayer
...
void ManageCamera(CBlob@ this)
{
	...
	// mouse look & zoom
    if ((getGameTime() - this.get_s32( "tap_time" ) > 1) && controls !is null)
    {
        ...
        else  if (controls.isKeyJustPressed( controls.getActionKeyKey(AK_ZOOMIN)) )
        {
       	...
       	//f32 delta = getGameTime() - this.get_s32( "tap_time" );
        zoom = zoomLevel*0.15;
    }
	...
	// camera
	camera.mouseFactor = 0.25f; // doesn't affect soldat cam
