...
class PNGLoader
{
	...
	{
		// sky
		map.CreateSky(color_black, Vec2f(1.0f, 1.0f), 369, "Sprites/Back/cloud", 0);
		map.CreateSkyGradient("Sprites/skygradient.png"); // override sky color with gradient

		// background
		map.AddBackground("Sprites/Back/BackgroundPlains.png", Vec2f(20.0f, -18.0f), Vec2f(0.6f, 0.6f), color_white);
		//map.AddBackground("Sprites/Back/BackgroundTrees.png", Vec2f(0.0f,  5.0f), Vec2f(0.7f, 0.6f), color_white);
...
map_colors::unused,                // | 256 |
map_colors::unused,                // | 257 |
map_colors::unused,                // | 258 |
map_colors::unused,                // | 259 |
map_colors::unused,                // | 260 |
map_colors::unused,                
map_colors::unused,                
map_colors::unused,                
map_colors::unused,                
...
map_colors::unused,                
map_colors::unused,                
map_colors::tile_sand,                // | 400 |
map_colors::tile_sand,                
map_colors::tile_sand,                
map_colors::tile_sand,                
map_colors::tile_sand,                
map_colors::tile_sand,                
